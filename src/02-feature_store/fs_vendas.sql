...
SELECT
    ...
    s.QtdSales7d, s.QtdSales14d, s.QtdSales28d, s.QtdSales42d, s.QtdSales56d, s.QtdSales84d,

    s.AvgSales7d, s.AvgSales14d, s.AvgSales28d, s.AvgSales42d, s.AvgSales56d, s.AvgSales84d,

    s.MinSales7d, s.MinSales14d, s.MinSales28d, s.MinSales42d, s.MinSales56d, s.MinSales84d,
    s.MaxSales7d, s.MaxSales14d, s.MaxSales28d, s.MaxSales42d, s.MaxSales56d, s.MaxSales84d,

    s.QtdSalesPromo7d, s.QtdSalesPromo14d, s.QtdSalesPromo28d, s.QtdSalesPromo42d, s.QtdSalesPromo56d, s.QtdSalesPromo84d,
    s.AvgSalesPromo7d, s.AvgSalesPromo14d, s.AvgSalesPromo28d, s.AvgSalesPromo42d, s.AvgSalesPromo56d, s.AvgSalesPromo84d,
    s.MinSalesPromo7d, s.MinSalesPromo14d, s.MinSalesPromo28d, s.MinSalesPromo42d, s.MinSalesPromo56d, s.MinSalesPromo84d,
    s.MaxSalesPromo7d, s.MaxSalesPromo14d, s.MaxSalesPromo28d, s.MaxSalesPromo42d, s.MaxSalesPromo56d, s.MaxSalesPromo84d,

    s.QtdSalesNoPromo7d, s.QtdSalesNoPromo14d, s.QtdSalesNoPromo28d, s.QtdSalesNoPromo42d, s.QtdSalesNoPromo56d, s.QtdSalesNoPromo84d,
    s.AvgSalesNoPromo7d, s.AvgSalesNoPromo14d, s.AvgSalesNoPromo28d, s.AvgSalesNoPromo42d, s.AvgSalesNoPromo56d, s.AvgSalesNoPromo84d,
    s.MinSalesNoPromo7d, s.MinSalesNoPromo14d, s.MinSalesNoPromo28d, s.MinSalesNoPromo42d, s.MinSalesNoPromo56d, s.MinSalesNoPromo84d,
    s.MaxSalesNoPromo7d, s.MaxSalesNoPromo14d, s.MaxSalesNoPromo28d, s.MaxSalesNoPromo42d, s.MaxSalesNoPromo56d, s.MaxSalesNoPromo84d,
    ...
    l.LiftSalesPromo7d, l.LiftSalesPromo14d, l.LiftSalesPromo28d, l.LiftSalesPromo42d, l.LiftSalesPromo56d, l.LiftSalesPromo84d,

    c.SalesGrowth42dYearAgo,

    v.SalesPerCustomer7d, v.SalesPerCustomer14d, v.SalesPerCustomer28d, v.SalesPerCustomer42d, v.SalesPerCustomer56d, v.SalesPerCustomer84d,
    v.AvgSalesPerCustomer7d, v.AvgSalesPerCustomer14d, v.AvgSalesPerCustomer28d, v.AvgSalesPerCustomer42d, v.AvgSalesPerCustomer56d, v.AvgSalesPerCustomer84d
